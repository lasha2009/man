...
def menu():
    sys.stdout.write(f" \x1b]2;| ქართული უძლიერესი ddos tool | by Op_Lasha<3 |\x07")
    clear()
    print(Fore.LIGHTGREEN_EX + '     [ Op_Lasha ] | კეთილი იყოს თქვენი მობრძანება op ის DDOS სამყაროში. | ახალი სკრიპტები! | ახალი სამყარო!')
    print("")
    print(Fore.LIGHTYELLOW_EX + """
                    
                            
                             ╔══════════════════════════════════════════════╗
                                  მოგესალმებით oplashas-ის  DDos სამყაროში!        
                                         საუკეთსო DDos მეთოდიები
                             ╚══════════════════════════════════════════════╝
                            ,-v-,
             ,.----,  ,  /^\|__,/^\   .  ,--'''-,
         ,'``       '' \J__/    \__\/` ''        `,
...
def main():
    menu()
    while(True):
        cnc = input(Fore.LIGHTGREEN_EX + '''╔══[DDos@man]
╚════>>''')
...
while True:
    ...
    if validator(username, password):
        ...
        print("</> მოგესალმებით op-ის DDos სამყაროში!")
        time.sleep(0.3)
        ascii_vro()
        main()
        break
        ...
        if attemps >= max_attemp:
            print(Fore.RED + "გადააჭარბა მაქსიმალურ მცდელობებს. გაა*ვი აქედან ყლე ბავშვო:)")
            break
